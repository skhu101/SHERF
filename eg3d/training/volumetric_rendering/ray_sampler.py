...
class RaySampler(torch.nn.Module):
    ...
    def forward(self, cam2world_matrix, intrinsics, resolution):
        ...
        ray_dirs = torch.nn.functional.normalize(ray_dirs, dim=2) # [1, resolution**2, 3]

        ray_origins = cam_locs_world.unsqueeze(1).repeat(1, ray_dirs.shape[1], 1) # [1, resolution**2, 3]
